...
export default async function VoorvertoningPage() {
  ...
  if (!settings || (!settings.contact_count && !settings.launch_date)) {
    return (
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Voorvertoning</h1>
        <div className="mt-8 flex flex-col items-center justify-center rounded-lg border border-gray-200 bg-white px-6 py-16 text-center">
          ...
          <h2 className="mt-4 text-lg font-semibold text-gray-800">Campagnegegevens worden voorbereid</h2>
          <p className="mt-2 max-w-md text-sm text-gray-500">
            De details van jouw campagne worden binnenkort hier zichtbaar.
          </p>
        </div>
      </div>
    )
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-gray-500">
        Een overzicht van jouw campagne-instellingen en doelgroep.
      </p>
