...
export function InboxShell({
  ...
  return (
    ...
    // te rekenen.
    //
    // Binnen die vaste box staat nu een kolom: bovenaan de rij met de antwoord
    // assistent, daaronder de drie panelen naast elkaar. Die rij blijft min-h-0,
    // zodat elk paneel zijn eigen scroll houdt.
    <AssistantProvider initialSettings={assistantSettings}>
      <div className="fixed inset-y-0 right-0 left-[var(--sidebar-w)] z-10 flex flex-col overflow-hidden bg-canvas pt-6 transition-[left] duration-200 lg:pt-8">
        <AssistantToolbar />
