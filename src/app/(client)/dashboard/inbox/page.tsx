    ...
    <div>
      ...
      <div className="mt-3 flex items-start gap-2.5 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3">
        ...
        <p className="text-xs leading-relaxed text-amber-800">
          <span className="font-semibold">Let op:</span> De inbox wordt momenteel niet ondersteund in Safari. Gebruik Google Chrome op uw MacBook. Mocht dit niet werken, probeer dan een incognito venster in Chrome. We werken eraan om dit in de toekomst op te lossen.
        </p>
      </div>
