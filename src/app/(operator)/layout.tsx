          ...
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-2.5">
              ...
              <h1 className="text-base font-bold text-gray-900">
                NextWave <span className="font-normal text-gray-400">Admin</span>
              </h1>
            </div>
