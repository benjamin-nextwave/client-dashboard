...
const LINKS: Array<{
  ...
  {
    href: (id) => `/admin/clients/${id}/loopgang`,
    label: 'Loopgang',
    description: 'Kalender: live-dagen, pauzes & facturen',
  ...
  {
    href: (id) => `/admin/clients/${id}/doelgroep`,
    label: 'Doelgroep',
    description: 'Sectoren, functies, locaties & notities',
  ...
  {
    href: (id) => `/admin/clients/${id}/weekrapporten`,
    label: 'Weekrapporten',
    description: 'PDF-rapporten uploaden & beheren',
  ...
  {
    href: (id) => `/admin/clients/${id}/kix`,
    label: 'KIX',
    description: 'Vrije werkpagina’s & aantekeningen',
