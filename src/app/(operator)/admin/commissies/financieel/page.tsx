    ...
    <div className="mx-auto max-w-5xl space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-gray-500">
          ...
          lopen per klant vanaf zijn eerste lead, ook op dagen zonder leads. Daarna gaan de kantoorkosten er nog af:
          €1.200 per aangeraakte maand. Klik op een klant voor het detail.
        </p>
      </header>
