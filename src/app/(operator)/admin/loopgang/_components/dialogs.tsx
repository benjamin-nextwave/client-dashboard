...
export function InvoiceDialog({ client, today, onClose }: DialogProps) {
  ...
  return (
    <Modal
      ...
      subtitle={`${client.displayName} — de factuurdatum wordt het nieuwe startpunt van de cyclus`}
      onClose={onClose}
    >
...
export function LeadReportDialog({ client, today, onClose }: DialogProps) {
  ...
  return (
    <Modal
      ...
      subtitle={`${client.displayName} — alleen zichtbaar in het admin dashboard, de klant ziet dit niet`}
      onClose={onClose}
    >
      <form action={submit} className="space-y-3">
        <div>
...
export function MeetingDialog({ client, today, onClose }: DialogProps) {
  ...
  return (
    <Modal
      ...
      subtitle={`${client.displayName} — maandelijkse evaluatiemeeting`}
      onClose={onClose}
    >
...
export function PauseDialog({ client, today, onClose }: DialogProps) {
  ...
  return (
    <Modal
      ...
      subtitle={`${client.displayName} — bevriest de loopgang, raakt Instantly niet`}
      onClose={onClose}
    >
      <div className="space-y-3">
        {client.isPaused ? (
...
export function TargetDialog({ client, onClose }: Omit<DialogProps, 'today'>) {
  ...
  return (
    <Modal
      ...
      subtitle={`${client.displayName} — mails per werkdag`}
      onClose={onClose}
    >
      <div className="space-y-3">
        <input
