...
const PROMPT = `Je zet een ingetypte toelichting bij een werktaak om in een zakelijke, feitelijke opsomming.
...
- Maximaal 8 punten. Korte, volledige zinnen.
- Nederlands, ook als de invoer een andere taal gebruikt.
- Geen markdown-opmaak binnen een punt: geen sterretjes, geen kopjes, geen nummering.

Wat je weglaat:
- Elk oordeel, gevoel of stemming, van wie dan ook. Dus niet "hij is boos", "vervelend", "irritant", "gefrustreerd", "balen".
- Elke aandrang of urgentie die niet als afspraak of datum is onderbouwd. Dus niet "snel snel", "asap", "met spoed", "heeft haast". Staat er een concrete datum of deadline, dan neem je die wél op als feit.
...
- Blijft er na het weglaten van oordelen niets feitelijks over, antwoord dan exact met: GEEN_FEITEN`
